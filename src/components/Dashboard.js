...
export default function Dashboard() {
  ...
  const getStaffsUrl = 'https://65321e684d4c2e3f333da188.mockapi.io/api/v1/staffs';
  const deleteStaffsUrl = `https://65321e684d4c2e3f333da188.mockapi.io/api/v1/staffs`;
        ...
        <Table sx={{ minWidth: 650 }} aria-label="simple table">
          <TableHead>
            <TableRow>
              ...
              {user && (<TableCell align="left">Action</TableCell>)}
            </TableRow>
          </TableHead>
          <TableBody>
            {APIData.map((staff) => (
